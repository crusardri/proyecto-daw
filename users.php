        ...
        <form class="item-filters">
           <label class="boxed-input searchbox">
                ...
                <div class="input-container">
                    <input autocomplete="off" type="text" placeholder="Buscar usuario por ID, Nombre de usuario, Correo, Nombre, Apellidos, o Teléfono " name="search" value="<?=$search?>" autofocus>
                </div>
            </label>
            <h1>Filtros</h1>
            <?=showRoleFilter();?>
